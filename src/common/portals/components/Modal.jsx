    ...
    <>
      {show && (
        <PortalWrapper name="modal">
          <div className="text-white absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#202020] bg-opacity-90 w-1/2 h-1/2">
            <div className="flex flex-col justify-center items-center p-1 h-full border border-white rounded-md">
              {controlOptions.map(({ keys, action }) => (
                <div className="flex justify-between w-1/2" key={action}>
                  <div>{action}</div>
